class PersonalTest {
    ...
    render() {
        if(this.page === 0){
            ...
            this.container.querySelector('.result_infor_title').innerHTML = `[ ${this.resultInfors[this.calcResult()].title} ]`
            this.container.querySelector('.result_infor').innerHTML = this.resultInfors[this.calcResult()].desc.split('<br />').map(el => {
                return `<li>${el}</li>`
            }).join('');
        }
